...
*   `callOptions` **[Object][7]** Call options.
    ...
    *   `callOptions.audioOptions` **[Object][7]?** Options for configuring the call's audio.
        ...
        *   `callOptions.audioOptions.deviceId` **[call.MediaConstraint][24]?** ID of the microphone to receive audio from.
    *   `callOptions.bandwidth` **[call.BandwidthControls][25]?** Options for configuring media's bandwidth.
    ...
    *   `callOptions.videoOptions` **[Object][7]?** Options for configuring the call's video.
        ...
        *   `callOptions.videoOptions.deviceId` **[call.MediaConstraint][24]?** ID of the camera to receive video from.
        *   `callOptions.videoOptions.height` **[call.MediaConstraint][24]?** The height of the video.
        *   `callOptions.videoOptions.width` **[call.MediaConstraint][24]?** The width of the video.
        *   `callOptions.videoOptions.frameRate` **[call.MediaConstraint][24]?** The frame rate of the video.
    ...
    *   `callOptions.screenOptions` **[Object][7]?** Options for configuring the call's screenShare.
        ...
        *   `callOptions.screenOptions.height` **[call.MediaConstraint][24]?** The height of the screenShare.
        *   `callOptions.screenOptions.width` **[call.MediaConstraint][24]?** The width of the screenShare.
        *   `callOptions.screenOptions.frameRate` **[call.MediaConstraint][24]?** The frame rate of the screenShare.
    ...
    *   `callOptions.customParameters` **[Array][13]<[call.CustomParameter][26]>?** Custom SIP header parameters for the SIP backend.
...
*   `customParameters` **[Array][13]<[call.CustomParameter][26]>** The locally set Custom Parameters for the call.
...
*   `media` **[Object][7]** The media options to add to the call. (optional, default `{}`)
    ...
    *   `media.audioOptions` **[Object][7]?** Options for configuring the call's audio.
        ...
        *   `media.audioOptions.deviceId` **[call.MediaConstraint][24]?** ID of the microphone to receive audio from.
    *   `media.videoOptions` **[Object][7]?** Options for configuring the call's video.

        *   `media.videoOptions.deviceId` **[call.MediaConstraint][24]?** ID of the camera to receive video from.
        *   `media.videoOptions.height` **[call.MediaConstraint][24]?** The height of the video.
        *   `media.videoOptions.width` **[call.MediaConstraint][24]?** The width of the video.
        *   `media.videoOptions.frameRate` **[call.MediaConstraint][24]?** The frame rate of the video.
    *   `media.screenOptions` **[Object][7]?** Options for configuring the call's screenShare.

        *   `media.screenOptions.height` **[call.MediaConstraint][24]?** The height of the screenShare.
        *   `media.screenOptions.width` **[call.MediaConstraint][24]?** The width of the screenShare.
        *   `media.screenOptions.frameRate` **[call.MediaConstraint][24]?** The frame rate of the screenShare.
...
*   `videoOptions` **[Object][7]?** Options for configuring the call's video.
    ...
    *   `videoOptions.deviceId` **[call.MediaConstraint][24]?** ID of the camera to receive video from.
    *   `videoOptions.height` **[call.MediaConstraint][24]?** The height of the video.
    *   `videoOptions.width` **[call.MediaConstraint][24]?** The width of the video.
    *   `videoOptions.frameRate` **[call.MediaConstraint][24]?** The frame rate of the video.
*   `options` **[Object][7]?** 
...
To check the media connection state of a call, retrieve the call's information using the  [call.getById][28] API,
